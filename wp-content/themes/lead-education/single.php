        ...
        <div id="primary" class="content-area">
            <main id="main" class="site-main" role="main">
					<?php while ( have_posts() ) : the_post(); ?>
						...
						<?php
						$post_pagination_enable = get_theme_mod( 'lead_education_enable_single_pagination', true );
						if ( $post_pagination_enable ) {
							the_post_navigation( array(
									'prev_text'          => lead_education_get_svg( array( 'icon' => 'left' ) ) . '<span>%title</span>',
									'next_text'          => '<span>%title</span>' . lead_education_get_svg( array( 'icon' => 'right' ) ),
								) );
						}
