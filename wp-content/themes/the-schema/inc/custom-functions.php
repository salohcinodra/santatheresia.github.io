...
function the_schema_scripts(){
    ...
    wp_enqueue_style('the-schema-google-fonts', the_schema_fonts_url() );
    ...
    if( get_theme_mod('ed_jquery_combined',false) ){
        ...
        wp_enqueue_script( 'sticky-sidebar', get_template_directory_uri() . '/js' . $build . '/sticky-sidebar' . $suffix . '.js', array( 'jquery' ), '3.3.1', true );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><?php printf( __( '%1$s is now installed and ready to use. Click below to see theme documentation, plugins to install and other details to get started.', 'the-schema' ), esc_html( $name ) ); ?></p>
