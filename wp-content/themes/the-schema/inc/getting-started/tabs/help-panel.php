...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://rarathemes.com/previews/?theme=the-schema' ); ?>" title="<?php esc_attr_e( 'Visit the Demo', 'the-schema' ); ?>" target="_blank">
